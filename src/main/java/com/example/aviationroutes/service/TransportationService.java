...
public class TransportationService {
    ...
    public Transportation updateTransportation(Long id, Transportation transportation){
        ...
        if(existingTrans.isPresent()){
            ...
            exist.setOriginLocationId(transportation.getOriginLocationId());
            exist.setOriginLocationName(transportation.getOriginLocationName());
            exist.setDestinationLocationId(transportation.getDestinationLocationId());
            exist.setDestinationLocationName(transportation.getDestinationLocationName());
    ...
    public Optional<Transportation> getLocationById(Long id){
        if(transportationRepository.existsById(id)){
